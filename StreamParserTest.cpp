...
int main(int argc, char *argv[]) {
	...
	uint16_t callID = 23232;
	
	char *stri = (char *)"hello world";
	
	uint8_t indexTable[] = { Object::T_UINT16, Object::T_UINT16, Object::T_INT16, Object::T_STRING, (uint8_t)(strlen(stri) + 1) };
	...
	o.uint16At(1, callID); //call id
	o.int16At(2, theInt); //payload argument
	o.strAt(3, stri, strlen(stri) + 1);
	
	if(o.int16At(2) != theInt) {
